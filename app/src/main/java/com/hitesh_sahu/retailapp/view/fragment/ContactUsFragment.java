...
public class ContactUsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getActivity().setTitle("Liên hệ chúng tôi");
        ...
        rootView.findViewById(R.id.contact_num).setOnClickListener(
                new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        callIntent.setData(Uri.parse("Số điện thoại:" + "0912345678"));
                ...
                new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent browserIntent = new Intent(
                                Intent.ACTION_VIEW,
                                Uri.parse("https://www.facebook.com/thuyvi180220/"));
        ...
        rootView.findViewById(R.id.email).setOnClickListener(
                new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        emailIntent.setType("Văn bản");
                        emailIntent
                                .putExtra(
                                        android.content.Intent.EXTRA_EMAIL,
                                        new String[]{"Tvkshop@gmail.com"});
                        emailIntent.putExtra(
                                android.content.Intent.EXTRA_SUBJECT,
                                "Chào bạn!");
                        emailIntent.putExtra(android.content.Intent.EXTRA_TEXT,
                                "Viết tin nhắn vào đây");
                        ...
                        try {
                            ...
                            Toast.makeText(getActivity(),
                                    "Không có ứng dụng email nào được cài đặt.",
